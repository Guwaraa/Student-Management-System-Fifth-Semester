...
@section('content')
    ...
    @if (auth()->user()->status != 'user')
        <div class="header">
            ...
            <form action="{{ route('classsSchedule.scheduledisplay') }}" method="POST">
                @csrf
    ...
    <div class="container">
        <div class="floating-form" id="formpage">
            ...
            <form action="{{ route('classsSchedule.schedulestore') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div style="display: flex; justify-content: space-evenly; width:100%; height:10%; padding: 5px;color:black"
                            ...
                            <div style=" width: 75%; display: flex;font-size: 16px;">
                                <div style="width: 70%;padding: 4px;font-size: 20px;">
                                    <a href="{{ route('classsSchedule.edit', [$data->id]) }} " target="_blank"
                                        class="show">
                                        <div>
                                            {{ $data->title }}
                                        </div>
                            ...
                            <div style=" width: 15%;  display: flex;justify-content:flex-end; text-align: right;">
                                <div style="width: 40%; font-size: 20px;padding-top: 10px; ">
                                    <form action="{{ route('classsSchedule.download') }}" method="POST">
                                        @csrf
                                ...
                                @if (auth()->user()->status != 'user')
                                    ...
                                    <div style="width: 40%; font-size: 20px;padding-top: 10px;">
                                        <form action="{{ route('classsSchedule.deletedata') }}" method="POST">
                                            @csrf
    ...
    @if (auth()->user()->status != 'user')
        ...
        <div class="footer-section">
            ...
            <div class="footer-section">
                <div class="add-btn">
                    <a href="{{ route('classsSchedule.create') }}">
